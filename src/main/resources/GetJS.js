(function() {
	...
	function xa(a) {
		if (!a) return "";
		if (nb(a)) return a.replace(/\s/g, ""); - 1 != a.indexOf("://") && (a = a.substr(a.indexOf("://") + 3));
	...
	function ob(a) {
		...
		} else a.parentNode.replaceChild(Aa(a),
		a)
	}
	function Ba(a, b, c, d) {
		la = !0;
		...
		var e = K(c);
		if (e) {
			"OBJECT" == e.nodeName ? (Z = Aa(e), ma = null) : (Z = e, ma = c);
	...
	function Fa() {
		...
		if (0 < a) for (var b = 0; b < a; b++) {
			...
			if (0 < n.pv[0]) {
				var f = K(c);
				if (f) if (!ja(M[b].swfVersion) || n.wk && 312 > n.wk) if (M[b].expressInstall && Da()) {
					e = {};
				...
				else P(c, !0), d && (e.success = !0, e.ref = Ea(c), d(e))
	...
	function Va(a) {
		...
		else if ("undefined" != typeof q.addEventListener) q.addEventListener("load",
		a, !1);
	...
	function W(a, b, c) {
		...
		u.cookie = a + "\x3d" + b + "; path\x3d/;expires \x3d " + d.toGMTString() +
			";domain\x3d" + xa(r.location.host.split(":")[0])
	}
	function Ga() {
	...
	if (!(Ha = R)) {
		var ca = Math,
			oa = {}, pa = oa.lib = {}, $a = function() {}, da = pa.Base = {
				extend: function(a) {
					$a.prototype = this;
					var b = new $a;
					a && b.mixIn(a);
	...
	for (var R = Ha, qa = Math, ra = R, S = ra.lib, xb = S.WordArray, sa = S.Hasher, S = ra.algo, cb = [],
	db = [], ta = 2, fa = 0; 64 > fa;) {
		var X;
		a: {
			X = ta;
			for (var yb = qa.sqrt(X), Ja = 2; Ja <= yb; Ja++) if (!(X % Ja)) {
				X = !1;
				break a
			}
			X = !0
	...
	var Ab = ["sessionStorage", "localStorage", "indexedDb", "openDatabase"],
		qb = 0;
	aa.prototype = {
		...
		getCanvasFp: function() {
			...
			c.fillText("Cwm fjordbank glyphs vext quiz, \ud83d\ude03",
			2, 15);
		...
		x64hash128: function(a, b) {
			...
			switch (c) {
				...
				case 8:
					g = this.x64Xor(g, this.x64LeftShift([0, a.charCodeAt(t + 7)], 56));
				case 7:
				...
				case 1:
					g = this.x64Xor(g, [0, a.charCodeAt(t)]), g = this.x64Multiply(g, k), g = this.x64Rotl(g, 31), g = this.x64Multiply(g, n), e = this.x64Xor(e, g)
			}
	...
	var Bb = ["scrDeviceXDPI", "scrColorDepth", "scrWidth", "scrHeight"],
		Y, J = r,
		q = u,
		O = k,
		fb = !1,
		...
		la = !1,
		L, ya, Ra = !0,
		n, Cb = "undefined" != typeof q.getElementById && "undefined" != typeof q.getElementsByTagName &&
			"undefined" != typeof q.createElement,
		ua = O.userAgent.toLowerCase(),
		va = O.platform.toLowerCase(),
		Db = va ? /win/.test(va) : /win/.test(ua),
		Eb = va ? /mac/.test(va) : /mac/.test(ua),
		Fb = /webkit/.test(ua) ? parseFloat(ua.replace(/^.*webkit\/(\d+(\.\d+)?).*$/, "$1")) : !1,
		Ka = !+"\x0B1",
		ga = [0, 0, 0],
		I = null;
	if ("undefined" != typeof O.plugins && "object" == typeof O.plugins["Shockwave Flash"])!(I = O.plugins["Shockwave Flash"].description) || "undefined" != typeof O.mimeTypes && O.mimeTypes["application/x-shockwave-flash"] && !O.mimeTypes["application/x-shockwave-flash"].enabledPlugin || (fb = !0, Ka = !1, I = I.replace(/^.*\s+(\S+\s+\S+$)/, "$1"), ga[0] = parseInt(I.replace(/^(.*)\..*$/, "$1"), 10), ga[1] = parseInt(I.replace(/^.*\.(.*)\s.*$/, "$1"), 10), ga[2] = /[a-zA-Z]/.test(I) ? parseInt(I.replace(/^.*[a-zA-Z]+(.*)$/, "$1"), 10) : 0);
	else if ("undefined" != typeof J.ActiveXObject) try {
		if (I = (new ActiveXObject("ShockwaveFlash.ShockwaveFlash")).GetVariable("$version")) Ka = !0, I = I.split(" ")[1].split(","), ga = [parseInt(I[0], 10), parseInt(I[1], 10), parseInt(I[2], 10)]
	} catch (a) {}
	n = {
		w3: Cb,
		wk: Fb,
	...
	n.w3 && (("undefined" != typeof q.readyState && "complete" == q.readyState || "undefined" == typeof q.readyState && (q.getElementsByTagName("body")[0] || q.body)) && V(), Q || ("undefined" != typeof q.addEventListener && q.addEventListener("DOMContentLoaded", V, !1), n.ie && n.win && (q.attachEvent("onreadystatechange", function b() {
	...
	Y = {
		...
		expressInstallCallback: function() {
			if (la) {
				...
				a && Z && (a.parentNode.replaceChild(Z, a), ma && (P(ma, !0), n.ie && n.win && (Z.style.display = "block")), Ca && Ca(Ua));
				la = !1
			}
		},
		addDomLoadEvent: Wa,
		createSWF: function(a, b, c) {
			if (n.w3) return za(a, b, c)
		},
		ua: n,
		addLoadEvent: Va,
		...
		embedSWF: function(a, b, c, d, e, f, g, l, k, p) {
			...
			n.w3 && !(n.wk && 312 > n.wk) && a && b && c && d && e ? (P(b, !1), Wa(function() {
				...
				if (ja(e)) n = za(h, m, b), h.id == b && P(b, !0), t.success = !0, t.ref = n;
				else {
					if (f && Da()) {
						h.data = f;
						Ba(h, m, b, p);
	...
	aa.VERSION = "1.4.2";
	var Gb = ["scrAvailWidth", "scrAvailHeight"],
	...
	try {
		var w = r,
			...
			ib = w.swfobject;
		try {
			var Ma = w.localStorage
		} catch (a) {}
		try {
			var Na = w.sessionStorage
		} catch (a) {}
		var ha, wa, jb = {
			...
			domain: xa(w.location.host.split(":")[0]),
			tests: 2,
		...
		w.evercookie = w.Evercookie = function(a) {
			...
			this._evercookie = function(a, c, d, B, l) {
				...
				void 0 === B && (B = 0);
				0 === B && (h.evercookie_database_storage(a, d), h.evercookie_indexdb_storage(a, d), b.authPath && h.evercookie_auth(a, d), f && h.evercookie_java(a, d), h._ec.userData = h.evercookie_userdata(a, d), h._ec.cookieData = h.evercookie_cookie(a, d), h._ec.localData = h.evercookie_local_storage(a,
				d), h._ec.globalData = h.evercookie_global_storage(a, d), h._ec.sessionData = h.evercookie_session_storage(a, d), h._ec.windowData = h.evercookie_window(a, d), e && (h._ec.historyData = h.evercookie_history(a, d)));
				if (void 0 !== d)("undefined" === typeof ha || "undefined" === typeof wa) && B++ < g && H(function() {
					h._evercookie(a, c, d, B, l)
				}, 300);
				else if ((w.openDatabase && "undefined" === typeof h._ec.dbData || ("indexedDB" in w || (w.indexedDB = w.indexedDB || w.mozIndexedDB || w.webkitIndexedDB || w.msIndexedDB)) && ("undefined" === typeof h._ec.idbData ||
					"" === h._ec.idbData) || "undefined" === typeof ha || "undefined" === typeof h._ec.etagData || "undefined" === typeof h._ec.cacheData || "undefined" === typeof h._ec.javaData || x.createElement("canvas").getContext && ("undefined" === typeof h._ec.pngData || "" === h._ec.pngData) || "undefined" === typeof wa) && B++ < g) H(function() {
					h._evercookie(a, c, d, B, l)
				}, 20);
				else {
			...
			this.evercookie_userdata = function(a, b) {
				try {
					...
					if (c.addBehavior) if (c.style.behavior = "url(#default#userData)", void 0 !== b) c.setAttribute(a, b), c.save(a);
			...
			this.evercookie_java = function(a, b) {
				...
				"undefined" !== typeof dtjava && (null !== d && void 0 !== d && d.length || (d = x.createElement("div"), d.setAttribute("id", "ecAppletContainer"),
				d.style.position = "absolute", d.style.top = "-3000px", d.style.left = "-3000px", d.style.width = "1px", d.style.height = "1px", x.body.appendChild(d)), "undefined" === typeof ecApplet ? dtjava.embed({
					width: "1px",
					id: "ecApplet",
					height: "1px",
			...
			this.evercookie_lso = function(a, b) {
				var c = x.getElementById("swfcontainer"),
					d = {}, e = {}, f = {};
				null !== c && void 0 !== c && c.length || (c = x.createElement("div"), c.setAttribute("id", "swfcontainer"),
			...
			this.evercookie_local_storage = function(a, b) {
				try {
					if (Ma) if (void 0 !== b) Ma.setItem(a, b);
					else return Ma.getItem(a)
				} catch (z) {}
			};
			...
			this.getHost = function() {
				return xa(w.location.host.split(":")[0])
			};
	...
	ia.prototype = {
		...
		getTouchSupport: function(a) {
			return new p("touchSupport",
			ba(a.replace(RegExp(",", "gm"), "#")))
		},
			...
			this.ec.get("RAIL_OkLJUJ", function(a) {
				...
				c.getDfpMoreInfo(function() {
					if (!(9E5 < G("RAIL_EXPIRATION") - (new Date).getTime() & null != G("RAIL_DEVICEID") & void 0 != G("RAIL_DEVICEID") & !c.NeedUpdate())) {
						for (var a = "", e = "", l = c.getpackStr(b), k = [], n = [], q = [], h = [], m = 0; m < l.length; m++) "new" != l[m].value && -1 == Hb.indexOf(l[m].key) && (-1 != Ab.indexOf(l[m].key) ? n.push(l[m]) : -1 != Gb.indexOf(l[m].key) ? q.push(l[m]) : -1 != Bb.indexOf(l[m].key) ? h.push(l[m]) : k.push(l[m]));
						l = "";
						...
						Ya.getJSON("https://kyfw.12306.cn/otn/HttpZF/logdevice" + ("?algID\x3dkoEzGW9FGs\x26hashCode\x3d" + e + a), null, function(a) {
							var b = JSON.parse(a);
							void 0 != kb && kb.postMessage(a, r.parent);
							for (var d in b) "dfp" == d ? G("RAIL_DEVICEID") != b[d] && (W("RAIL_DEVICEID",
							b[d], 1E3), c.deviceEc.set("RAIL_DEVICEID", b[d])) : "exp" == d ? W("RAIL_EXPIRATION", b[d], 1E3) : "cookieCode" == d && (c.ec.set("RAIL_OkLJUJ", b[d]), W("RAIL_OkLJUJ", "", 0))
						})
					}
				})
			}, 1)
		...
		checkWapOrWeb: function() {
			return "WindowsPhone" == Ga() || "iOS" == Ga() || "Android" == Ga() ? !0 : !1
		},
		...
		hashAlg: function(a, b, c) {
			...
			c = a.length;
			d = "";
			d = 0 == a.length % 2 ? a.substring(c / 2, c) + a.substring(0, c / 2) : a.substring(c / 2 + 1,
			c) + a.charAt(c / 2) + a.substring(0, c / 2);
			d = Pa(d);
			e = d.length;
		...
		getHasLiedBrowser: function(a) {
			return new p("hasLiedBrowser", a)
		},
		getHasLiedResolution: function(a) {
			return new p("hasLiedResolution",
			a)
		},
	...
	u.addEventListener ? u.addEventListener("DOMContentLoaded", function b() {
		...
		lb || "interactive" != u.readyState && "complete" != u.readyState || (u.detachEvent("onreadystatechange", c), Oa(), lb = !0)
	})
})();